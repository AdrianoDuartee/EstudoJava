...
public class CalculadoraIMC {
    public static void main(String[] args) {
        ...
        System.out.printf("Olá, meu nome e %s e tenho %d anos!\n", nome, idade);
        ...
        System.out.println("Selecione um dieta ( 1 a 3)");
        ...
        switch(dieta) {
            case 1:
                System.out.println("Você escolheu a dieta da água");
                        break; // impedir de testar as condicoes abaix
            case 2:
        ...
        System.out.println("Vocè tem quantos alimentos preferidos?");
